          ...
          <button class="user-button ${
            ...
            ${
              this.headerTheme === 'dark'
                ...
                : `<img class="user-button-img" src="assets/icons/user-icon.svg" alt="user-button-img">`
            }
          </button>
          <button
           class="post-project-button ${
             this.headerTheme === 'dark'
               ? 'primary-dark-btn'
               : 'primary-light-btn'
           }">
          ...
          <button class="menu-button ${
            ...
            ${
              this.headerTheme === 'dark'
                ...
                : `<img class="menu-button-icon" src="assets/icons/menu-icon.svg" alt="menu-button-img">`
            }
            <img class="close-button-icon" src="assets/icons/close-icon.svg" alt="close-button-img"> 
          </button> 
        </div> 
      </header>
